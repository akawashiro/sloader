...
std::map<std::string, Elf64_Addr> sloader_libc_map = {
    ...
    {"__explicit_bzero_chk", reinterpret_cast<Elf64_Addr>(nullptr)},
    {"__fdelt_chk", reinterpret_cast<Elf64_Addr>(nullptr)},
    ...
    {"__strcat_chk", reinterpret_cast<Elf64_Addr>(nullptr)},
    {"__strcat_chk", reinterpret_cast<Elf64_Addr>(nullptr)},
    ...
    {"__vsnprintf_chk", reinterpret_cast<Elf64_Addr>(nullptr)},
    {"__vsnprintf_chk", reinterpret_cast<Elf64_Addr>(nullptr)},
    {"__xpg_basename", reinterpret_cast<Elf64_Addr>(nullptr)},
